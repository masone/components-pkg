...
## D. Seller-web inventory

The raw generated consumer lookup table is in
[seller-web-inventory.md](seller-web-inventory.md). It retains every public JSX component
row and its custom/Chakra-surface prop counts; it does not make findings or recommendations.
